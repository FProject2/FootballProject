...
public class ReserveModel {
	...
	@RequestMapping("reserve/payment.do")
	public String reservePayment(HttpServletRequest request, HttpServletResponse response) {
		request.setAttribute("main_jsp", "../reserve/payment.jsp");
	...
	@RequestMapping("reserve/calendar.do")
			  ...
			  HttpServletResponse response)
	  {
		  ...
		  {
			  String time=dao.footballReserve_GetTime(Integer.parseInt(st.nextToken()));
			  list.add(time);
		  }
